...
public class NuevaPartida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        boton3.setBounds(xBot,(int) (tamPant.getHeight()*0.73), largoBot, anchoBot);
        ...
        boton2.setBounds(xBot,(int) (tamPant.getHeight()*0.52), largoBot, anchoBot);
        ...
        botonAtras.setBounds((int) (xBot *0.45),(int) (tamPant.getHeight()*0.14), (int) ((int) largoBot*0.2), (int) ( anchoBot *0.2));
    ...
    private boolean comprobacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalirActionPerformed
        ...
        ConfirmarSalida confirmar= new ConfirmarSalida(new JFrame(), true, " Ya existe una partida en este lugar.\n\n ¿Estas seguro de que quieres eliminar esta partida?", true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new NuevaPartida().setVisible(true));
    }
